...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<Map<String,dynamic>?> getResponse(File imageFile) async{
    ...
    final imgUploadRequest=http.MultipartRequest("POST",Uri.parse("http://max-image-caption-generator-test.2886795278-80-elsy07.environments.katacoda.com/model/predict"));
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Center(
                child: loading
                //if true display ui for pick image or capture or live image
                ?Container(
                ...
                //implement/display ui for showing results
                :Container(
